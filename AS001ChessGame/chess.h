...
#ifndef AS001CHESSGAME_CHESS_H
#define AS001CHESSGAME_CHESS_H
#include <vector>
#include <string>
...
std::vector<std::pair<int, int>> find_move_bishop_by_location(std::string move_location, int x, int y, Color color, ChessBoard board);
std::vector<std::pair<int, int>> find_move_bishop_diagonal(ChessBoard board, int x, int y, Color color);
std::vector<std::pair<int, int>> find_move_bishop_antidiagonal(ChessBoard board, int x, int y, Color color);
...
std::vector<std::pair<int, int>> find_move_rook_vertical(ChessBoard board, int x, int y, Color color);
